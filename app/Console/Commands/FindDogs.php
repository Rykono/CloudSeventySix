...
use App\Mail\PetFinder\NewDogsEmail;

use Ixudra\Curl\Facades\Curl;
use Mail;

class FindDogs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'petfinder:dogs';
    ...
    public function handle()
    {
        ...
        $page = 1;
        $totalPages = 1;
        $response = Curl::to('https://api.petfinder.com/v2/animals?location=20191&distance=15&type=Dog&age=baby&limit=100&page'. $page)
                    ->withHeaders([
    ...
    {
      Mail::to('dmtitus5@gmail.com')->send(new NewDogsEmail($this->newAnimals));
      Mail::to('alexandrafrith2018@gmail.com')->send(new NewDogsEmail($this->newAnimals));
